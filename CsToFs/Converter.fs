...
//let run (input:string) = 
    ...
    //    | CsToFs.Namespace ns -> FormatOuput.toNamespace ns [] |> List.singleton |> FormatOuput.toFile
    //    | CsToFs.Class cn ->  cn  |> FormatOuput.toClass |> List.singleton |> FormatOuput.defaultModule |> FormatOuput.toFile
    //    | CsToFs.Method m ->  m |> FormatOuput.toMethod |> FormatOuput.toDefaultClass |> List.singleton |> FormatOuput.defaultModule |> FormatOuput.toFile
    //    | CsToFs.Field f ->  f |> Seq.head |> FormatOuput.inMethod |> FormatOuput.toMethod |> FormatOuput.toDefaultClass |> List.singleton |> FormatOuput.defaultModule |> FormatOuput.toFile
    //    )
